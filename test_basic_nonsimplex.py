...
def mds(X,D, max_step=16, energy_limit=1e-3, temperature=1, damping_factor=1.05,
    ...
    libbasic_nonsimplex.mds_solve(p, X.shape[0], X.shape[1], d, max_step,
...
if __name__ == "__main__":
    ...
    p = random.normal(2,3,6).reshape((3,2))

    p_final = mds(p, D, verbose_mode=0)
