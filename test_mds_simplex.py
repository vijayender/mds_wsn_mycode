...
def mds(X,D, max_step=16, energy_limit=1e-3, iters=100, verbose_mode=1):
    ...
    print
    libbasic_sa = CDLL('libmds_simplex.so')
    libbasic_sa.mds_solve.argtypes = [p_t, c_int, c_int, p_t, c_float,  c_float, c_int, c_int];
...
if __name__ == "__main__":
    ...
    p_final = mds(p_r, D, iters=100000, verbose_mode=0)
